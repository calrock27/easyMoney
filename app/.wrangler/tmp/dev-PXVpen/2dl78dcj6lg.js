...
// .wrangler/tmp/pages-MxYVK7/bundledWorker-0.6112548547092291.mjs
...
var ce = /* @__PURE__ */ __name2((e, t, r, s) => {
  if (t && typeof t == "object" || typeof t == "function") for (let a of ae(t)) !ie.call(e, a) && a !== r && H(e, a, { get: /* @__PURE__ */ __name2(() => t[a], "get"), enumerable: !(s = ne(t, a)) || s.enumerable });
  return e;
}, "ce");
var $ = /* @__PURE__ */ __name2((e, t, r) => (r = e != null ? re(oe(e)) : {}, ce(t || !e || !e.__esModule ? H(r, "default", { value: e, enumerable: true }) : r, e)), "$");
var m;
var l = j(() => {
  m = { collectedLocales: [] };
});
...
async function J(e) {
  ...
  try {
    ...
    switch (e.method) {
      ...
      case "POST": {
        let o = globalThis[_e], n = /* @__PURE__ */ __name2(async () => {
          let i = await e.json();
...
var k = class {
  ...
  async checkRoute(t, r) {
    ...
    if (n.check && !P(this.path)) if (h === this.path) {
      if (t !== "miss") return this.checkPhase(U(t));
      this.status = 404;
    } else if (t === "miss") {
  ...
  async checkPhase(t) {
    ...
    let a = "miss";
    return s || t === "miss" || t === "error" ? a = "hit" : r && (a = U(t)), this.checkPhase(a);
  }
  async run(t = "none") {
...
function je() {
  ...
  return new Proxy(globalThis, { get: /* @__PURE__ */ __name2((t, r) => e.has(r) ? e.get(r) : Reflect.get(globalThis, r), "get"), set: /* @__PURE__ */ __name2((t, r, s) => Me.has(r) ? Reflect.set(globalThis, r, s) : (e.set(r, s), true), "set") });
}
__name(je, "je");
__name2(je, "je");
...
// .wrangler/tmp/pages-MxYVK7/2dl78dcj6lg.js
...
// .wrangler/tmp/bundle-4n79b9/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-4n79b9/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=2dl78dcj6lg.js.map
