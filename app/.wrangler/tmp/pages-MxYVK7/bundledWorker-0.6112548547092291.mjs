...
var ce = /* @__PURE__ */ __name((e, t, r, s) => {
  if (t && typeof t == "object" || typeof t == "function") for (let a of ae(t)) !ie.call(e, a) && a !== r && H(e, a, { get: /* @__PURE__ */ __name(() => t[a], "get"), enumerable: !(s = ne(t, a)) || s.enumerable });
  return e;
}, "ce");
var $ = /* @__PURE__ */ __name((e, t, r) => (r = e != null ? re(oe(e)) : {}, ce(t || !e || !e.__esModule ? H(r, "default", { value: e, enumerable: true }) : r, e)), "$");
var m;
var l = j(() => {
  m = { collectedLocales: [] };
});
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.6112548547092291.mjs.map
